...
public class SendMessageContactsFragment extends Fragment implements ContactsFragment, ContactServiceClient, LoginServiceClient {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        view.setBackgroundColor(ContextCompat.getColor(getActivity(), R.color.background_send_message_active));
    ...
    public void setContacts(final List<ContactEntity> contacts) {
        getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                listView.setAdapter(new SendMessageContactsAdapter(
                        getActivity(),
                        R.layout.item_contact,
                        contacts,
                        SendMessageContactsFragment.this));
