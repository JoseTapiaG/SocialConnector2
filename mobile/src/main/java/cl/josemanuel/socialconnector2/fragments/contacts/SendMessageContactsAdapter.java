...
public class SendMessageContactsAdapter extends ArrayAdapter<ContactEntity> {
    ...
    public SendMessageContactsAdapter(
    ...
    private void setClickListener(View view, final ContactEntity contactEntity) {
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.replace(R.id.content_fragment, sendMessageFragment);
